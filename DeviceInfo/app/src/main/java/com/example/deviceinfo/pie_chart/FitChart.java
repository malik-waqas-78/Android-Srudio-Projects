 ...
 */
package com.example.deviceinfo.pie_chart;
...
import com.example.deviceinfo.interfaces.Pie_chart_Renderer;
...
public class FitChart extends View {
    ...
    private AnimMode animMode = AnimMode.LINEAR;
    ...
    private void readAttributes(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            int attrAnimationMode = attributes.getInteger(R.styleable.FitChart_animMode, ANIMATION_MODE_LINEAR);
            if (attrAnimationMode == ANIMATION_MODE_LINEAR) {
                animMode = AnimMode.LINEAR;
            } else {
                animMode = AnimMode.OVERDRAW;
            }
            attributes.recycle();
        }
    }
    ...
    private void renderValue(Canvas canvas, FitChartValue value) {
        if (!isInEditMode()) {
            ...
            Pie_chart_Renderer renderer = RendererFactory.getRenderer(animMode, value, drawingArea);
