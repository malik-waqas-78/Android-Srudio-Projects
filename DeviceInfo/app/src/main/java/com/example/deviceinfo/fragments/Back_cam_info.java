...
import com.example.deviceinfo.databinding.FragmentBackCamInfoBinding;
...
public class Back_cam_info extends Fragment {
    FragmentBackCamInfoBinding binding;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        binding.backcamRecycler.setLayoutManager(new LinearLayoutManager(context));
        binding.backcamRecycler.setAdapter(general_info_adapter);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        info_models.add(new General_info_Model(getResources().getString(R.string.resolution),getBackCameraResolutionInMp()));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding=FragmentBackCamInfoBinding.inflate(inflater,container,false);
