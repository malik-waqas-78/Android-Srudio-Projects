...
class GeneralMediaAdapterAAT(var context: Context, mfiles: ArrayList<AllFilesModelClassAAT>) :
    RecyclerView.Adapter<GeneralMediaAdapterAAT.ViewHolder>() {
...
//            }
    ...
    inner class ViewHolder(val binding: RowGeneralMediaAatBinding) : RecyclerView.ViewHolder(binding.root) {
        init {
