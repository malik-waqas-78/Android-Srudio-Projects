...
import com.photo.recovery.constants.MyConstantsAAT.Companion.TAG

import java.util.*
import kotlin.collections.ArrayList


class NativeAdHelperAAT {

    companion object {
        var fbNativeAd: NativeAd? = null
        fun loadFbNativeAd(context: Context) {
            fbNativeAd = NativeAd(context, context.resources.getString(R.string.fb_native_ad))
...
//        fun showFbNativeAd(context: Context, nativeAdLayout: NativeAdLayout) {
//            /*  if(nativeAds==null){
//                 // prepareAdd(context)
//                  return
//              }*/
//            if (fbNativeAd?.isAdInvalidated == true && fbNativeAd?.isAdLoaded != true) {
...
//            val adView =
//                inflater.inflate(R.layout.fb_native_layout_aat, nativeAdLayout, false) as LinearLayout
...
//
//            // Set the Text.
//            nativeAdTitle.text = fbNativeAd?.advertiserName
//            nativeAdBody.text = fbNativeAd?.adBodyText
//            nativeAdSocialContext.text = fbNativeAd?.adSocialContext
//            nativeAdCallToAction.setVisibility(if (fbNativeAd?.hasCallToAction() == true) View.VISIBLE else View.INVISIBLE)
//            nativeAdCallToAction.setText(fbNativeAd?.adCallToAction)
//            sponsoredLabel.text = fbNativeAd?.sponsoredTranslation
//
...
//        }
        ...
        private fun prepareAdMobNativeAdView(
            nativeAd: com.google.android.gms.ads.nativead.NativeAd,
            googleAdView: NativeAdView
        ) {
            // Set the media view.
            googleAdView.mediaView =
                googleAdView.findViewById<MediaView>(R.id.ad_media) as com.google.android.gms.ads.nativead.MediaView
        ...
        public fun loadAdmobNativeAd(context: Context) {
            ...
            val builder =
                AdLoader.Builder(context, context.resources.getString(R.string.admob_native_ad))
        ...
        fun showAdmobNativeAd(context: Context, frameLayout: FrameLayout) {
            ...
            val adView = LayoutInflater.from(context)
                .inflate(R.layout.admob_nativead_aat, null) as NativeAdView
