...
public final class ActivityUpdateRecordBinding implements ViewBinding {
  ...
  private ActivityUpdateRecordBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button btnAddMore, @NonNull Button btnAddSub, @NonNull Button btnUpdate,
      @NonNull CardView cardRecyclerSub, @NonNull TextView cashInDate, @NonNull TextView cashInTime,
      @NonNull EditText editAmount, @NonNull EditText editMainRemarks,
      @NonNull EditText editRemarks, @NonNull View line, @NonNull View line1,
      @NonNull LinearLayout linearViewRecord, @NonNull LinearLayout linearaddrecord,
      @NonNull RecyclerView recyclerSub, @NonNull TextView totalAmountTextIn) {
  ...
  @NonNull
  public static ActivityUpdateRecordBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityUpdateRecordBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_update_record, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityUpdateRecordBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUpdateRecordBinding((ConstraintLayout) rootView, btnAddMore, btnAddSub,
          btnUpdate, cardRecyclerSub, cashInDate, cashInTime, editAmount, editMainRemarks,
          editRemarks, line, line1, linearViewRecord, linearaddrecord, recyclerSub,
          totalAmountTextIn);
    }
