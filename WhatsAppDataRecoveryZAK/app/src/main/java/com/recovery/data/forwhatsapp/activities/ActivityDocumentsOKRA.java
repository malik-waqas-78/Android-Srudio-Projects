...
import com.recovery.data.forwhatsapp.documentspkg.AdapterDocumentsOKRA;
import com.recovery.data.forwhatsapp.documentspkg.DocumentsManageRecoveryDirectoryOKRA;
import com.recovery.data.forwhatsapp.documentspkg.DocumentsUrlInterfaceOKRA;

import java.io.File;
import java.lang.reflect.Field;
import java.util.ArrayList;

public class ActivityDocumentsOKRA extends AppCompatActivity implements DocumentsUrlInterfaceOKRA, LongClickInterfaceOKRA {

    private static final String TAG = "92727";
    RecyclerView recyclerView;
    AdapterDocumentsOKRA _documents_adapter;
    ArrayList<File> document_files = new ArrayList<>();
    DocumentsManageRecoveryDirectoryOKRA manage_directory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_documents_okra);
...
//        }
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                _documents_adapter.getFilter().filter(newText);
                return true;
            }
        });
        linearSelected.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectall.size()==0) {
                    ...
                    for (int i = 0; i < document_files.size(); i++) {
                        selectall.add(document_files.get(i).getAbsolutePath());
                    }
                    _documents_adapter.setSelectedRows(selectall);
                    _documents_adapter.notifyDataSetChanged();
                }else{
                    selectDot.setBackgroundResource(R.drawable.ic_unchek_icon);
                    _documents_adapter.setSelectedRows(new ArrayList<String>());
                    selectall.clear();
                    _documents_adapter.notifyDataSetChanged();
                }
            }
    ...
    private void initComponents() {
        manage_directory = new DocumentsManageRecoveryDirectoryOKRA();
        ...
        linearSelected=findViewById(R.id.linearSelectAll7);
        selectDot=findViewById(R.id.imageselectdot7);
        GridLayoutManager layoutManager = new GridLayoutManager(this, 3);
        recyclerView.setLayoutManager(layoutManager);
        //init adapter
        _documents_adapter = new AdapterDocumentsOKRA(document_files, this);
        _documents_adapter.setDocuments_url_interface(this);
        _documents_adapter.setLongClickListeners(this);
        //setAadapteData
    ...
    class DeleteSelectedItems implements View.OnClickListener {
        ...
        public void onClick(View view) {
            if(_documents_adapter.getSelectedRows().size()>0) {
                deleteWarningDialog();
            }else{
                Toast.makeText(ActivityDocumentsOKRA.this, "Kindly Select Atleast one Document", Toast.LENGTH_SHORT).show();
            }
...
//    }
    ...
    private void deleteWarningDialog() {
        Dialog dialog = new Dialog(ActivityDocumentsOKRA.this);
...
//                delete.setVisibility(View.VISIBLE);
    ...
    public void setUrlandLaunchInterface(String url) {
        ...
        Uri uri = FileProvider.getUriForFile(getApplicationContext(), getApplicationContext().getResources().getString(R.string.authority), new File(url));
        intent.setData(uri);
        startActivity(intent);
//        fragment=true;
//        recyclerView.setVisibility(View.GONE);
...
//
//        com.google.android.gms.ads.AdView mAdView = new com.google.android.gms.ads.AdView(ActivityDocumentsAAT.this);
//        com.google.android.gms.ads.AdSize adSize = AATAdmobFullAdManager.getAdSize(ActivityDocumentsAAT.this);
