...
import com.voicesms.voice.Activities.PlayAudio_VS;
...
import com.voicesms.voice.databinding.RowLayoutRecordingsBinding;
...
import static com.voicesms.voice.Utils.Constants.NAME;
import static com.voicesms.voice.Utils.Constants.URL;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(RowLayoutRecordingsBinding inflate) {
            ...
            binding.cardviewRecordingList.setOnClickListener(view -> {
                ...
                context.startActivity(new Intent(context, PlayAudio_VS.class)
