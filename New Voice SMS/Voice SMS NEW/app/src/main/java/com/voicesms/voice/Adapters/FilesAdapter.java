...
import com.voicesms.voice.Activities.FileViewActivity_VS;
...
public class FilesAdapter extends RecyclerView.Adapter<FilesAdapter.ViewHolder> {
    ...
    private final FileViewActivity_VS.Files_Interface filesInterface;

    public FilesAdapter(Context context, ArrayList<Model_Class> mDataSet, FileViewActivity_VS.Files_Interface filesInterface) {
