...
import com.voicesms.voice.Dialogs.Rename_file_Dialog_Voice_SMS
...
import com.voicesms.voice.Utils.Constants.NAME
import com.voicesms.voice.Utils.Constants.URL
import com.voicesms.voice.databinding.ActivityPlayAudioBinding
import java.io.File
...
class PlayAudio_VS : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.recording_menu_share -> {
                ...
                if (file.exists()) {
                    val uri =
                        FileProvider.getUriForFile(this, "com.voicesms.voice.fileprovider", file)
