...
import com.voicesms.voice.Adapters.Image_Preview_Adapter;
import com.voicesms.voice.Adapters.Language_Adapter;
import com.voicesms.voice.Adapters.myDatabaseAdapter;
import com.voicesms.voice.Dialogs.DataClear_Dialog_Voice_SMS;
import com.voicesms.voice.Dialogs.GeneralDialog_VoiceSMS;
import com.voicesms.voice.Interfaces.ClearTextDialogInterface_Voice_SMS;
...
import com.voicesms.voice.databinding.ActivitySmsBinding;
...
import static com.voicesms.voice.Utils.Constants.KEY_OPEN_MESSAGE;
import static com.voicesms.voice.Utils.Constants.KEY_TXT_MESSAGE;
import static com.voicesms.voice.Utils.Constants.Max_files;
import static com.voicesms.voice.Utils.Constants.NAV_BOTTOM_COPY_ID;
import static com.voicesms.voice.Utils.Constants.NAV_BOTTOM_DOCS_ID;
import static com.voicesms.voice.Utils.Constants.NAV_BOTTOM_IMAGE_ID;
import static com.voicesms.voice.Utils.Constants.NAV_BOTTOM_SAVE_ID;
import static com.voicesms.voice.Utils.Constants.NAV_DRAWER_DELETE_ALL_ID;
import static com.voicesms.voice.Utils.Constants.NAV_DRAWER_NEW_ID;
import static com.voicesms.voice.Utils.Constants.NAV_DRAWER_OPEN_ID;
import static com.voicesms.voice.Utils.Constants.NAV_DRAWER_RATE_ID;
import static com.voicesms.voice.Utils.Constants.NAV_DRAWER_SAVE_ID;
import static com.voicesms.voice.Utils.Constants.NAV_DRAWER_SHARE_ID;
...
public class SMSActivity_VS extends AppCompatActivity {
...
//        loadBannerAdd();
    ...
    private void initListeners() {
        ...
        nav_drawer.setNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                    ...
                    GeneralDialog_VoiceSMS.CreateGeneralDialog(this
                            ...
                            , new GeneralDialogInterface_voiceSMS() {
                                ...
                                public void Positive(Dialog dialog) {
                                    startActivity(new Intent(SMSActivity_VS.this, SMSActivity_VS.class));
                                    finish();
                                }
                ...
                case NAV_DRAWER_OPEN_ID:
                    startActivityForResult(new Intent(this, OpenMessagesActivity_VS.class)
                            , Constants.OPEN_MESSAGE_ACTIVITY_REQUEST_CODE);
                    break;
                case NAV_DRAWER_SAVE_ID:
                    if (voice_input_result.length() > 0) {
                        copyText();
                        Toast.makeText(SMSActivity_VS.this, "Message Copied.", Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(SMSActivity_VS.this, "Please Enter a message first", Toast.LENGTH_SHORT).show();
                    }
                    collapseDrawer();
                    break;
                ...
                case NAV_DRAWER_SHARE_ID:
                    startSharing(SMSActivity_VS.this);
                    break;
                    ...
                    case NAV_BOTTOM_SAVE_ID: {
                        if (voice_input_result.length() > 0) {
                            if (!myDbAdapter.searchInDb(voice_input_result.getText().toString())) {
                                ...
                                Toast.makeText(SMSActivity_VS.this, "Message saved.", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(SMSActivity_VS.this, "Message Already Exists.", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(SMSActivity_VS.this, "Please Enter a message first", Toast.LENGTH_SHORT).show();
                        }
        ...
        btnSend.setOnClickListener(view -> {
            ...
            if (textInput.length() > 0 || files_list.size() > 0) {
                Intent intent = new Intent(SMSActivity_VS.this, SendMessageActivity_VS.class);
        ...
        switch (MODE) {
            ...
            case FILE_PICKER: {
                if (isPermissionAllowed(Manifest.permission.READ_EXTERNAL_STORAGE) &&
                    ...
                    startActivity(new Intent(this, FileViewActivity_VS.class));
                } else {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        Temp_Remember_MODE = MODE;
            ...
            case IMAGE_PICKER: {
                if (isPermissionAllowed(Manifest.permission.READ_EXTERNAL_STORAGE) &&
                        isPermissionAllowed(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    startActivity(new Intent(this, ImageViewActivity_VS.class));
                } else {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        Temp_Remember_MODE = MODE;
                        requestPermissions(new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, Constants.REQUEST_READ_EXTERNAL_STORAGE_PERMISSION);
                    ...
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            if (!shouldShowRequestPermissionRationale(Manifest.permission.READ_EXTERNAL_STORAGE)) {
                                showMessageOKCancel("You need voice allow read access voice storage voice Access media files",
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
                    ...
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                        ...
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            if (!shouldShowRequestPermissionRationale(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                                showMessageOKCancel("You need voice allow write access voice storage voice Access media files",
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(Settings.ACTION_APPLICATION_DETAILS_SETTINGS);
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(SMSActivity_VS.this)
                .setMessage(message)
    ...
    private void startSharing(SMSActivity_VS smsActivity) {
    ...
    private void initRecyclerView() {
        ...
        Image_Preview_Adapter adapter = new Image_Preview_Adapter(SMSActivity_VS.this);
    ...
    public void copyText() {
        ...
        if (textInput != null) {
            ...
            Toast.makeText(this, "Error:: No Text voice Copy", Toast.LENGTH_SHORT).show();
        }
    }
