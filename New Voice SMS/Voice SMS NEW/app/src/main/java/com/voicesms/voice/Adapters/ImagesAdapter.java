...
import com.voicesms.voice.Activities.ImageViewActivity_VS;
...
public class ImagesAdapter extends RecyclerView.Adapter<ImagesAdapter.ViewHolder> {
    ...
    private final ImageViewActivity_VS.imageInterface imageInterface;

    public ImagesAdapter(Context context, ArrayList<Model_Class> mDataSet, ImageViewActivity_VS.imageInterface imageInterface) {
