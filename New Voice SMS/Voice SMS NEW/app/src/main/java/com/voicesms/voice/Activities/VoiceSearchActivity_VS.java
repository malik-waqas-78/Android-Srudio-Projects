...
import com.voicesms.voice.Adapters.Language_Adapter;
...
import com.voicesms.voice.Models.Lang_Item;
import com.voicesms.voice.R;
import com.voicesms.voice.Utils.Constants;
import com.voicesms.voice.Utils.Shared_Pref_Helper_Voice_SMS;
import com.voicesms.voice.databinding.ActivityVoiceSearchBinding;
...
import static com.voicesms.voice.Utils.Constants.ALIBABA;
import static com.voicesms.voice.Utils.Constants.ALIEXPRESS;
import static com.voicesms.voice.Utils.Constants.AMAZON;
import static com.voicesms.voice.Utils.Constants.BING;
import static com.voicesms.voice.Utils.Constants.DARAZ;
import static com.voicesms.voice.Utils.Constants.DEFAULT_LOCALE;
import static com.voicesms.voice.Utils.Constants.DUCK;
import static com.voicesms.voice.Utils.Constants.EBAY;
import static com.voicesms.voice.Utils.Constants.FACEBOOK;
import static com.voicesms.voice.Utils.Constants.FLIPBOARD;
import static com.voicesms.voice.Utils.Constants.GOOGLE;
import static com.voicesms.voice.Utils.Constants.GOOGLE_MAPS;
import static com.voicesms.voice.Utils.Constants.IMDB;
import static com.voicesms.voice.Utils.Constants.INSTAGRAM;
import static com.voicesms.voice.Utils.Constants.MEDIUM;
import static com.voicesms.voice.Utils.Constants.MSN;
import static com.voicesms.voice.Utils.Constants.OLX;
import static com.voicesms.voice.Utils.Constants.PINTEREST;
import static com.voicesms.voice.Utils.Constants.QUORA;
import static com.voicesms.voice.Utils.Constants.REDDIT;
import static com.voicesms.voice.Utils.Constants.SEARCH_QUERY;
import static com.voicesms.voice.Utils.Constants.SEARCH_SOURCE_NAME;
import static com.voicesms.voice.Utils.Constants.SELECTED_LOCALE;
import static com.voicesms.voice.Utils.Constants.STACK_OVERFLOW;
import static com.voicesms.voice.Utils.Constants.TIKTOK;
import static com.voicesms.voice.Utils.Constants.TWITTER;
import static com.voicesms.voice.Utils.Constants.VOICE_NAV_BOTTOM_CLEAR_ID;
import static com.voicesms.voice.Utils.Constants.VOICE_NAV_BOTTOM_SEARCH_ID;
import static com.voicesms.voice.Utils.Constants.WIKI;
import static com.voicesms.voice.Utils.Constants.YAHOO;
import static com.voicesms.voice.Utils.Constants.YOUTUBE;
import static com.voicesms.voice.Utils.Constants.locale_array_list;

public class VoiceSearchActivity_VS extends AppCompatActivity {
...
//        InterstitialAddsVoiceSMS.showAdd();
                        ...
                        switch (item.getItemId()) {
                            case VOICE_NAV_BOTTOM_CLEAR_ID: {
                                if (binding.resultTextviewSearchActivity.getText().toString().length() > 0) {
                                    GeneralDialog_VoiceSMS.CreateGeneralDialog(VoiceSearchActivity_VS.this,
                                    ...
                                    Toast.makeText(VoiceSearchActivity_VS.this, "Text field is empty!", Toast.LENGTH_SHORT).show();
                                }
                            }
                            break;
                            case VOICE_NAV_BOTTOM_SEARCH_ID:
                                ...
                                if (textInput.length() > 0) {
                                    ...
                                    Toast.makeText(VoiceSearchActivity_VS.this, "No Messages Found", Toast.LENGTH_SHORT).show();
                                }
                                break;
                        }
                        return false;
        ...
        binding.langSpinnerSearchActivity.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (spinnerCount > 0) {
                    // Prevent first click due voice OnCreateView() by using a counter
    ...
    private void start_activity(String url) {
        startActivity(new Intent(this, WebViewActivity_VS.class)
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new AlertDialog.Builder(VoiceSearchActivity_VS.this)
                .setMessage(message)
    ...
    private void setupRecognizer() {
        ...
        speechRecognizer.setRecognitionListener(new RecognitionListener() {
            ...
            public void onError(int error) {
                Toast.makeText(VoiceSearchActivity_VS.this, getErrorText(error), Toast.LENGTH_SHORT).show();
                binding.animationViewSearchActivity.setVisibility(View.INVISIBLE);
