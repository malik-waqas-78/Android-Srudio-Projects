...
import com.voicesms.voice.Adapters.SearchListAdapter;
import com.voicesms.voice.Models.Search_List_Item;
import com.voicesms.voice.R;
import com.voicesms.voice.Utils.Constants;
import com.voicesms.voice.databinding.ActivitySearchOptionsListBinding;

import java.util.ArrayList;

public class SearchOptionsList_VS extends AppCompatActivity {
    private String listMode;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        com.voicesms.voice.databinding.ActivitySearchOptionsListBinding binding = ActivitySearchOptionsListBinding.inflate(getLayoutInflater());
