...
import com.example.profilepicturedownloaderforinstagrame.BuildConfig;
import com.example.profilepicturedownloaderforinstagrame.models.UserObject;
...
public class ZoomstaUtil {
    ...
    public static void addToFav(Context context, ArrayList cart_data) {
    ...
    public static void appendExistingFavList(Context context, UserObject favUserModel) {
        ...
        addToFav(context, (ArrayList) favUserModelList);
    ...
    public static void removeFav(Context context, UserObject favUserModel) {
        ...
        addToFav(context, new ArrayList<>());
        addToFav(context, (ArrayList) getCarts);
    }
