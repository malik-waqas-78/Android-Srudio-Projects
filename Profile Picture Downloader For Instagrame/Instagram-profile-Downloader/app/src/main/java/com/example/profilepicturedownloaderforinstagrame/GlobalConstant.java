...
public class GlobalConstant {
    ...
    public static final String DOWNLOADED_FILENAME = "InstaSaver-";
    public static final String APP_NAME = "InstaSaver-";
    ...
    public static final String SEMI_BOLD_COLOR = "WorkSans_semiRegular.ttf";
    ...
    public static final String IGTV_DOWNLOAD = "Download IGTV videos";
    public static final String PROFILE_PICTURE = "Download Profile Pic";
    public static final String FAVOURITES = "Favourites";
    public static final String POST = "Download Posts";
    ...
    public static final String DOWNLOAD_HISTORY = "Downloaded History";
    ...
    public static final String SAVED_FILE_NAME = APP_NAME;
    ...
    public static final String FOLLOWED_BY = "followes_by";


    //data-sharing keys between activities and fragments
