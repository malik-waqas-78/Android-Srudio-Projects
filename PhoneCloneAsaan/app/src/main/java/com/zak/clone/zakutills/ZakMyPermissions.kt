...
class ZakMyPermissions(var appContext: Context, var activityContext: Context) {
    companion object {
        ...
        fun showStorageExplanation(activity: Activity,callBack:ExplanationCallBack,msgParam:String="") {
            ...
            ZakMyDialogues.showRational(activity,storagePermission[1], title, msg,callBack)
        }
        ...
        fun requestContactsPermission(activity: Activity) {
            ActivityCompat.requestPermissions(
                ...
                ZakMyConstants.CONTACTS_PERMISSIONS_REQUEST_CODE
            )
        }
        ...
        fun showContactsExplanation(activity: Activity,callBack:ExplanationCallBack) {
            ...
            ZakMyDialogues.showRational(activity,contactsPermissions[1], title, msg,callBack)
        }
        ...
        fun requestCalendarPermission(activity: Activity) {
            ActivityCompat.requestPermissions(
                ...
                ZakMyConstants.CALEDAR_PERMISSION_REQUEST_CODE
            )
        }
        ...
        fun showCalendarExplanation(activity: Activity,callBack:ExplanationCallBack) {
            ...
            ZakMyDialogues.showRational(activity,calendarPermission[0], title, msg,callBack)
        }
        ...
        fun showLocationExplanation(activity: Activity,callBack:ExplanationCallBack) {
            ...
            ZakMyDialogues.showRational(activity,locationPermissions, title, msg,callBack)
        }
                ...
                when (status.statusCode) {
                    LocationSettingsStatusCodes.RESOLUTION_REQUIRED -> try {
                        ...
                        status.startResolutionForResult(
                            ...
                            ZakMyConstants.REQUEST_LOCATION_TURNON
                        )
