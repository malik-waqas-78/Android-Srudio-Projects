...
class ZakFileSharingModel(var filePath:String?, var fileType:String, var pathToSave:String, var fileName:String="") :Serializable{
    ...
    fun getThisFilesType():String{
        return ZakMyConstants.FILE_TYPE
    }
