...
class ZakSplashScreen : AppCompatActivity(), ZakDialogueClickListener {


    var iv_start: Button? = null

    var tv_privacyPolicy: TextView? = null

    var HSMyPermissions: ZakMyPermissions? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.zak_activity_splashscreen)
 ...
 //         }
   ...
   /* @RequiresApi(Build.VERSION_CODES.M)
    ...
    private fun privacyDialog() {
        val dialog = Dialog(this@ZakSplashScreen, android.R.style.Theme_Black_NoTitleBar_Fullscreen)
        dialog.setContentView(R.layout.zak_dialog_privacy)
    ...
    private fun launchChooseMobile() {
        var intent = Intent(this@ZakSplashScreen, ZakActivityChooseDevice::class.java)
