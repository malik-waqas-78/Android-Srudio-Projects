...
public class ZakP2PBroadcastReceiver extends BroadcastReceiver {
    ...
    private ZakDirectCallBack mDirectActionListener;

    public ZakP2PBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, ZakDirectCallBack directActionListener) {
