...
import com.smartswitch.phoneclone.adapters.CAPPAdapterApps
...
class CAPPActivityInstallApps :AppCompatActivity() {

    var appsList=ArrayList<CAPPAppsModel>()

    var rc_contacts: RecyclerView?=null

    var HSAdapter_install_apps: CAPPAdapterApps?=null
    ...
    override fun onCreate(
        ...
        setContentView(R.layout.install_apps_capp)


        findViewById<Toolbar>(R.id.toolbar).setNavigationIcon(R.drawable.ic_group_back_white)
        findViewById<Toolbar>(R.id.toolbar).setNavigationOnClickListener(View.OnClickListener {
            onBackPressed()
        })
...
//        )
    ...
    inner class LoadData : AsyncTask<Void, Void, Void>() {
        ...
        override fun onPostExecute(result: Void?) {
            ...
            if (this@CAPPActivityInstallApps.isDestroyed || this@CAPPActivityInstallApps.isFinishing) {
                return
            }
            ...
            if (appsList.size > 0) {
                ...
                var linearLayoutManager = LinearLayoutManager(this@CAPPActivityInstallApps)
                linearLayoutManager.orientation = LinearLayoutManager.VERTICAL
                rc_contacts?.layoutManager = linearLayoutManager
                //create HSAdapter
                HSAdapter_install_apps = CAPPAdapterApps(this@CAPPActivityInstallApps, appsList)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode== CAPPMConstants.INSTALL_APPS){
            LoadData().execute()
        }
    }
    ...
    fun exitorcontinue() {
        ...
        negative.setOnClickListener {
            setResult(CAPPMConstants.INSTALL_APPS)
            finish()
        }
