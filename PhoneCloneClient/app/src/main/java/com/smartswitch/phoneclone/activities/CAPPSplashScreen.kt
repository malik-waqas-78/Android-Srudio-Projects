...
//import com.switchphone.transferdata.ads.AATIntersitialAdHelper.Companion.isAppInstalledFromPlay
//import com.switchphone.transferdata.ads.AATIntersitialAdHelper.Companion.loadAdmobBanner
...
import com.smartswitch.phoneclone.utills.CAPPAppVersionChecker
import com.smartswitch.phoneclone.utills.CAPPMPermissions


class CAPPSplashScreen : AppCompatActivity(), CAPPDialogueClickListener,
    CAPPAppVersionChecker.VersionCallBack {


    var iv_start: TextView? = null

    var tv_privacyPolicy: TextView? = null

    var HSMyPermissions: CAPPMPermissions? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_splashscreen_capp)

//        if (isAppInstalledFromPlay(this)) {
//            AATIntersitialAdHelper.loadAdmobInterstitial_mediated(this)
////            AATIntersitialAdHelper.loadAdmobInterstitial_simple(this)
//            loadAdmobBanner(
//                this,
...
//            )
//
//            AATNativeAdHelper.loadAdmobNativeAd(this)
//        }
...
//            checkStoragePermissionForAllVersionndroid()
 ...
 //         }
    ...
    private fun privacyDialog() {
        val dialog = Dialog(this@CAPPSplashScreen, android.R.style.Theme_Black_NoTitleBar_Fullscreen)
    ...
    private fun launchChooseMobile() {
        var intent = Intent(this@CAPPSplashScreen, CAPPActivityChooseDevice::class.java)
