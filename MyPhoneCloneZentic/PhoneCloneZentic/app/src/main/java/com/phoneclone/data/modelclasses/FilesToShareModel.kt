...
class FilesToShareModel(var context: Context, fileType: String, items: Int, totalBytes: Long?) {
    ...
    init {
        ...
        when (fileType) {
            MyConstants.FILE_TYPE_APPS -> {
                ...
                icon = context.applicationContext.resources.getDrawable(R.drawable.ic_apk, null)
            }
            MyConstants.FILE_TYPE_VIDEOS -> {
                sizeDetails = """Size : $dataToShareInFormat"""
                itemsCountDetails = """Items : $noOfItems """
                icon = context.applicationContext.resources.getDrawable(R.drawable.ic_video, null)
            }
            MyConstants.FILE_TYPE_CALENDAR -> {
                sizeDetails = """size : --- """
                itemsCountDetails = """Items : $noOfItems """
                icon = context.applicationContext.resources.getDrawable(R.drawable.ic_calendar, null)
            }
            MyConstants.FILE_TYPE_PICS -> {
                sizeDetails = """Size : $dataToShareInFormat"""
                itemsCountDetails = """Items : $noOfItems """
                icon = context.applicationContext.resources.getDrawable(R.drawable.ic_pics, null)
            }
            MyConstants.FILE_TYPE_CONTACTS -> {
                sizeDetails = """size : --- """
                itemsCountDetails = """Items : $noOfItems """
                icon = context.applicationContext.resources.getDrawable(R.drawable.ic_contact, null)
            }
            MyConstants.FILE_TYPE_DOCS -> {
                sizeDetails = """Size : $dataToShareInFormat"""
                itemsCountDetails = """Items : $noOfItems """
                icon = context.applicationContext.resources.getDrawable(R.drawable.ic_docs, null)
            }
