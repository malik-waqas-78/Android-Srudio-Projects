...
class MyPermissions(var appContext: Context, var activityContext: Context) {
    companion object {
        ...
        fun showStorageExplanation(activity: Activity,callBack:ExplanationCallBack,msgParam:String="") {
            ...
            MyDialogues.showRational(activity,storagePermission[1], title, msg,callBack)
        }
        ...
        fun requestContactsPermission(activity: Activity) {
            ActivityCompat.requestPermissions(
                ...
                MyConstants.CONTACTS_PERMISSIONS_REQUEST_CODE
            )
        }
        ...
        fun showContactsExplanation(activity: Activity,callBack:ExplanationCallBack) {
            ...
            MyDialogues.showRational(activity,contactsPermissions[1], title, msg,callBack)
        }
        ...
        fun requestCalendarPermission(activity: Activity) {
            ActivityCompat.requestPermissions(
                ...
                MyConstants.CALEDAR_PERMISSION_REQUEST_CODE
            )
        }
        ...
        fun showCalendarExplanation(activity: Activity,callBack:ExplanationCallBack) {
            ...
            MyDialogues.showRational(activity,calendarPermission[0], title, msg,callBack)
        }
        ...
        fun showLocationExplanation(activity: Activity,callBack:ExplanationCallBack) {
            ...
            MyDialogues.showRational(activity,locationPermissions, title, msg,callBack)
        }
                ...
                when (status.statusCode) {
                    LocationSettingsStatusCodes.RESOLUTION_REQUIRED -> try {
                        ...
                        status.startResolutionForResult(
                            ...
                            MyConstants.REQUEST_LOCATION_TURNON
                        )
