...
public class P2PBroadcastReceiver extends BroadcastReceiver {
    ...
    private DirectCallBack mDirectActionListener;

    public P2PBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, DirectCallBack directActionListener) {
