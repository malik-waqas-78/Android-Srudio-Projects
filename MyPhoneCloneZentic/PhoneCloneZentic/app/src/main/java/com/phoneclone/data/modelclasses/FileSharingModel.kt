...
class FileSharingModel(var filePath:String?, var fileType:String,var pathToSave:String,var fileName:String="") :Serializable{
    ...
    fun getThisFilesType():String{
        return MyConstants.FILE_TYPE
    }


    fun getMyFileName():String {
        var name=fileName
        if(fileType==MyConstants.FILE_TYPE_APPS){
            name+=".apk"
        }
        return name;
    }
