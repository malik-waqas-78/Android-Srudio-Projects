...
import com.phone.clone.constants.HSMyConstants.get.HOTOSPOT_SETTINGS_CODE
...
class HSActivityChooseDevice : AppCompatActivity(), HSDialogueClickListener {
...
//         }
   ...
   /* override fun onRequestPermissionsResult(
    ...
    override fun allowPermission(permission: String) {
        ...
        intent.data = uri
        var requestCode = 0
        startActivityForResult(intent, HSMyConstants.PERMISSIONS_REQUSTCODE)
    }
    ...
    fun launchOldPhoneActivity() {
        ...
        /*if (!wifiUtilsClass!!.getWifiState()) {
            ...
            if (HSMyPermissions!!.CheckIfGPSisOn()) {*/
                val intent = Intent(this, HSDataSelectionActivity::class.java)
                startActivity(intent)
            /*} else {
                HSMyPermissions!!.turnGpsOn()
            }
