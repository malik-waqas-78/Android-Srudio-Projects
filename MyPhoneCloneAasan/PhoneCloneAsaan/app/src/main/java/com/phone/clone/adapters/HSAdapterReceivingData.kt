...
class HSAdapterReceivingData (var context: Context, HSTransferData: ArrayList<HSTransferDataModel>) : RecyclerView.Adapter<HSAdapterReceivingData.MyViewHolder>() {



    var myDataList = ArrayList<HSTransferDataModel>()
