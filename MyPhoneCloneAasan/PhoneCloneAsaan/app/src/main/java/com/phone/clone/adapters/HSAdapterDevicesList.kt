...
class HSAdapterDevicesList(var context: Context, var wifiP2pDeviceList: List<WifiP2pDevice>) :
    RecyclerView.Adapter<HSAdapterDevicesList.DevicesViewHolder>() {

    val HSWifiP2PCallBacks:HSWifiP2PCallBacks=context as HSWifiP2PCallBacks
