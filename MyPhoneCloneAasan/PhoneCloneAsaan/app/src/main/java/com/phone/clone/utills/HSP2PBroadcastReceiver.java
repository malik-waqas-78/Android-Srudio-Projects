...
public class HSP2PBroadcastReceiver extends BroadcastReceiver {
    ...
    private HSDirectCallBack mDirectActionListener;

    public HSP2PBroadcastReceiver(WifiP2pManager wifiP2pManager, WifiP2pManager.Channel channel, HSDirectCallBack directActionListener) {
