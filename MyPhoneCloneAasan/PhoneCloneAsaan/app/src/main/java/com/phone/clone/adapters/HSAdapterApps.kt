...
class HSAdapterApps(var context: Context, var appSrcDir: ArrayList<HSAppsModel>) :
    RecyclerView.Adapter<HSAdapterApps.ApplicationViewHolder>() {
    ...
    fun installThisApp(label: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            (context as Activity).startActivityForResult(install, HSMyConstants.INSTALL_APPS)
            // finish()
        } else {
            val install = Intent(Intent.ACTION_VIEW)
