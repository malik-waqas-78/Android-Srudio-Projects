package com.ash360.cool.AdUtils;
...
public class NativeAdsCoolDoorLock {
    ...
    public static void showAd(Context context, NativeAdLayout nativeAdLayout) {
        ...
        LinearLayout adView = (LinearLayout) inflater.inflate(R.layout.fb_native_layout_cool_door_lock, nativeAdLayout, false);
