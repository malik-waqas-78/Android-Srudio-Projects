...
public class SubFolderVideosAdapter extends RecyclerView.Adapter<SubFolderVideosAdapter.ViewHolder> {
    Context context;
    ArrayList<String> filesInFolder;

    public SubFolderVideosAdapter(Context context, ArrayList<String> filesInFolder) {
