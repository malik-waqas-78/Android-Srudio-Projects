...
public class StatusVideoFullAdapter extends RecyclerView.Adapter<StatusVideoFullAdapter.ViewHolder> {

    Context context;
    ArrayList<ImagesModelClass> status_video_list;
    private String TAG;
    public StatusVideoFullAdapter(Context context, ArrayList<ImagesModelClass> status_video_list) {
