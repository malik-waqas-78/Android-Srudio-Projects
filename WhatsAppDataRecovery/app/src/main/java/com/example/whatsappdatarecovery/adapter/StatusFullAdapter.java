...
public class StatusFullAdapter extends RecyclerView.Adapter<StatusFullAdapter.ViewHolder> {

    Context context;
    ArrayList<ImagesModelClass> imagesArrayList;
    public StatusFullAdapter(Context context, ArrayList<ImagesModelClass> imagesArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ((ViewHolder) holder).delete_btn.setOnClickListener(v -> {
    ...
    private String getPathToDelete(String name) {
        ...
        String path=load_Directory_files(new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/WhatsApp/Media/WhatsApp Videos"),purename);
        return path;
    }
