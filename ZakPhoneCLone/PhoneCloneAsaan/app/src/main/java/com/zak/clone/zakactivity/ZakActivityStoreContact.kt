...
class ZakActivityStoreContact : AppCompatActivity()  {
    ...
    var HSAdapter_Contacts:ZakAdapterContacts?=null
    ...
    override fun onCreate(
        ...
        setContentView(R.layout.zak_store_contacts)
       /* admobBanner()*/
        onViewCreated()
    }
    ...
    inner class asyncTask : AsyncTask<Unit,Unit,Unit>(){
        ...
        override fun onPreExecute() {
            super.onPreExecute()
           progressDialog = ProgressDialog(this@ZakActivityStoreContact)
        ...
        override fun onPostExecute(result: Unit?) {
            ...
            if(this@ZakActivityStoreContact.isDestroyed||this@ZakActivityStoreContact.isFinishing){
                return
            }
    ...
    inner class LoadContactsFile() : AsyncTask<Void, Void, Void>() {
        ...
        override fun doInBackground(vararg p0: Void?): Void? {
            ...
            try {
                ...
                while (line != null) {
                    ...
                    if (tokens.size > 0) {
                        var contact = ZakContactsModel(
                            tokens[ZakContactsModel.NAME_INDEX],
                            tokens[ZakContactsModel.PHONE_NUMBER_INDEX]
                        )
        ...
        override fun onPostExecute(result: Void?) {
            ...
            if (contactsList.size > 0) {
                ...
                var linearLayoutManager = LinearLayoutManager(this@ZakActivityStoreContact)
                linearLayoutManager.orientation = LinearLayoutManager.VERTICAL
                rc_contacts?.layoutManager = linearLayoutManager
                //create HSAdapter
                HSAdapter_Contacts = ZakAdapterContacts(this@ZakActivityStoreContact, contactsList)
...
//                "Are you sure you want to Allow permissions?")
        positive.setOnClickListener {
            dialog.dismiss()
            val intent=Intent()
            intent.putExtra(ZakMyConstants.isContactsSaved,isContactsSaved)
            setResult(ZakMyConstants.STORE_CONTACTS,intent)
            finish()
        }
    ...
    fun backPressed() {
        ...
        dialog.setContentView(R.layout.zak_db_contacts_back_prerssed)
        dialog.getWindow()!!.setBackgroundDrawable(ColorDrawable(Color.TRANSPARENT))
