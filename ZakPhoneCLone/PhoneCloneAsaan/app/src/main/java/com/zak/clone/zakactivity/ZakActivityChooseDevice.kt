...
import com.zak.clone.zakconstants.ZakMyConstants.get.HOTOSPOT_SETTINGS_CODE
...
class ZakActivityChooseDevice : AppCompatActivity(), ZakDialogueClickListener {
   /* var HSMyPermissions: HSMyPermissions? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.zak_activity_choose_mobile)
...
//         }
   ...
   /* override fun onRequestPermissionsResult(
    ...
    override fun allowPermission(permission: String) {
        ...
        intent.data = uri
        var requestCode = 0
        startActivityForResult(intent, ZakMyConstants.PERMISSIONS_REQUSTCODE)
    }
    ...
    override fun isAndroid10() {
        val intent = Intent(this, ZakWifiP2PCreateGroupAndReceive::class.java)
        startActivity(intent)
    }
    ...
    fun launchOldPhoneActivity() {
        ...
        /*if (!wifiUtilsClass!!.getWifiState()) {
            ...
            if (HSMyPermissions!!.CheckIfGPSisOn()) {*/
                val intent = Intent(this, ZakDataSelectionActivity::class.java)
                startActivity(intent)
            /*} else {
                HSMyPermissions!!.turnGpsOn()
            }
