...
import com.zak.clone.zakadapters.ZakAdapterApps
...
class ZakActivityInstallApps :AppCompatActivity() {

    var appsList=ArrayList<ZakAppsModel>()

    var rc_contacts: RecyclerView?=null

    var HSAdapter_install_apps: ZakAdapterApps?=null
    ...
    override fun onCreate(
        ...
        setContentView(R.layout.zak_install_apps)
...
/*
    ...
    inner class LoadData : AsyncTask<Void, Void, Void>() {
        ...
        override fun onPostExecute(result: Void?) {
            ...
            if (this@ZakActivityInstallApps.isDestroyed || this@ZakActivityInstallApps.isFinishing) {
                return
            }
            ...
            if (appsList.size > 0) {
                ...
                var linearLayoutManager = LinearLayoutManager(this@ZakActivityInstallApps)
                linearLayoutManager.orientation = LinearLayoutManager.VERTICAL
                rc_contacts?.layoutManager = linearLayoutManager
                //create HSAdapter
                HSAdapter_install_apps = ZakAdapterApps(this@ZakActivityInstallApps, appsList)
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(requestCode== ZakMyConstants.INSTALL_APPS){
            LoadData().execute()
        }
    }
    ...
    fun exitorcontinue() {
        ...
        negative.setOnClickListener {
            setResult(ZakMyConstants.INSTALL_APPS)
            finish()
        }
