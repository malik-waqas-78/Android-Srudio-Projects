package com.data.usage.manager.core.worker;

import com.data.usage.manager.core.base.Connection;
import com.data.usage.manager.core.base.Utils;
import com.data.usage.manager.core.config.SpeedtestConfig;
import com.data.usage.manager.core.config.TelemetryConfig;
import com.data.usage.manager.core.download.DownloadStream;
import com.data.usage.manager.core.getIP.GetIP;
import com.data.usage.manager.core.log.Logger;
import com.data.usage.manager.core.ping.PingStream;
import com.data.usage.manager.core.serverSelector.TestPoint;
import com.data.usage.manager.core.telemetry.Telemetry;
import com.data.usage.manager.core.upload.UploadStream;
