...
//    private static final File OUTPUT_DIR = new File(TEMP_FOLDER_PATH+"images2Video"+System.currentTimeMillis()+".mp4");
...
//        String outputPath = new File(TEMP_FOLDER_PATH+"images2Video"+System.currentTimeMillis()+".mp4").getPath();
