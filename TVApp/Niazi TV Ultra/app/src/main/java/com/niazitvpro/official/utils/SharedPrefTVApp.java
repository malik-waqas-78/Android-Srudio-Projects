...
public class SharedPrefTVApp {
    ...
    public SharedPrefTVApp(Context appContext) {
...
// except for the ones that make the content appear under the system bars.
    ...
    public  static void runTimer(Activity activity,final ProgressBar progressbar){
        ...
        if(!activity.isFinishing()){
            ...
            handler.postDelayed(new Runnable(){
                public void run(){
                    ...
                    switch (count){
                        case 0:
                            progressbar.getIndeterminateDrawable().setColorFilter(activity.getResources().getColor(android.R.color.holo_red_dark), android.graphics.PorterDuff.Mode.SRC_IN);
                            break;
                        case 1:
                            progressbar.getIndeterminateDrawable().setColorFilter(activity.getResources().getColor(android.R.color.holo_red_dark), android.graphics.PorterDuff.Mode.SRC_IN);
                            break;
                        case 2:
                            progressbar.getIndeterminateDrawable().setColorFilter(activity.getResources().getColor(android.R.color.holo_blue_dark), android.graphics.PorterDuff.Mode.SRC_IN);
                            break;
                        case 3:
                            progressbar.getIndeterminateDrawable().setColorFilter(activity.getResources().getColor(android.R.color.holo_green_dark), android.graphics.PorterDuff.Mode.SRC_IN);
                            break;
                        case 4:
                            progressbar.getIndeterminateDrawable().setColorFilter(activity.getResources().getColor(android.R.color.holo_orange_dark), android.graphics.PorterDuff.Mode.SRC_IN);
                            break;
                    }
