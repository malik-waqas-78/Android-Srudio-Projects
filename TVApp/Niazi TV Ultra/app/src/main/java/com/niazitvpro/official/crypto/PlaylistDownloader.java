...
package com.niazitvpro.official.crypto;

import android.os.AsyncTask;

import com.niazitvpro.official.utils.Log;
...
public class PlaylistDownloader {
    ...
    private void downloadInternal(final URL segmentUrl, final String outFile, final int currProgress,final int size) {
        ...
        new AsyncTask<Void, Integer, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                Log.log("Downloading segment: "+ size);
                Log.log("Downloading segment: "+ outFile);
                Log.log("Downloading segment: "+ currProgress*100/size);
            ...
            protected void onProgressUpdate(Integer... values) {
                ...
                String totalAndRemain = "Segment:=" + currProgress + " / "+size;
                Log.log("Progress:"+values[0]  +  "%"  + "   " + totalAndRemain);
                downloadListener.onProgressUpdate("Progress:="+values[0]  +  "%"  + "   " + totalAndRemain,values[0]);
            }
        }.execute();
    }
    ...
    public interface DownloadListener{
        void onProgressUpdate(String progress,int progressCount);
