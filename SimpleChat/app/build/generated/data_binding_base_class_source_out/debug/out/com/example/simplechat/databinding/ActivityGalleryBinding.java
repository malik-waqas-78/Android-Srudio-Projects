...
public final class ActivityGalleryBinding implements ViewBinding {
  ...
  private ActivityGalleryBinding(@NonNull ConstraintLayout rootView, @NonNull RecyclerView rv) {
  ...
  public static ActivityGalleryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGalleryBinding((ConstraintLayout) rootView, rv);
    }
