...
public final class ImageLayoutBinding implements ViewBinding {
  ...
  private ImageLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout cardView3, @NonNull ImageView image) {
  ...
  public static ImageLayoutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout cardView3 = (ConstraintLayout) rootView;
      ...
      return new ImageLayoutBinding((ConstraintLayout) rootView, cardView3, image);
    }
